    ...
    public partial class MLModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"ProductId",inputColumnName:@"ProductId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"TotalPrice",MatrixColumnIndexColumnName=@"UserCode",MatrixRowIndexColumnName=@"ProductId",ApproximationRank=10,LearningRate=0.09576516858678413,NumberOfIterations=210,Quiet=true}))      
